...
Registering the DirectShow Filter "atmods.dll" you need the tool regsvr32.exe

c:\atmo\>regsvr32.exe atmods.dll  

or just invoke/start the shellscript "register.cmd" inside the programfolder
as Administrator.
