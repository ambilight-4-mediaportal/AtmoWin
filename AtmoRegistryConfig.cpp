...
void CAtmoRegistryConfig::LoadSettings(HKEY mykey, std::string profile1) 
{
	...
	//CheckByteValue( ReadRegistryInt(mykey, newconfigRootKey,"WhiteAdjustment_Red",m_WhiteAdjustment_Red) );
	m_WhiteAdjustment_Red    = CheckByteValue(GetProfile().GetIntOrDefault("AtmoWinX", "WhiteAdjustment_Red", m_WhiteAdjustment_Red));
	//CheckByteValue( ReadRegistryInt(mykey, newconfigRootKey,"WhiteAdjustment_Green",m_WhiteAdjustment_Green) );
	m_WhiteAdjustment_Green  = CheckByteValue(GetProfile().GetIntOrDefault("AtmoWinX", "WhiteAdjustment_Green", m_WhiteAdjustment_Green));
	//CheckByteValue( ReadRegistryInt(mykey, newconfigRootKey,"WhiteAdjustment_Blue",m_WhiteAdjustment_Blue) );
	m_WhiteAdjustment_Blue   = CheckByteValue(GetProfile().GetIntOrDefault("AtmoWinX", "WhiteAdjustment_Blue", m_WhiteAdjustment_Blue));
	//(ReadRegistryInt(mykey, newconfigRootKey,"UseSoftwareWhiteAdj",m_UseSoftwareWhiteAdj) != 0);
	m_UseSoftwareWhiteAdj    =  (GetProfile().GetIntOrDefault("AtmoWinX", "UseSoftwareWhiteAdj", m_UseSoftwareWhiteAdj) != 0);
	m_UseSoftware2WhiteAdj    = 0;
	//(ReadRegistryInt(mykey, newconfigRootKey,"UseColorK",m_UseColorKWhiteAdj) != 0);
	m_UseColorKWhiteAdj		  = (GetProfile().GetIntOrDefault("AtmoWinX", "UseColorK", m_UseColorKWhiteAdj) != 0);
	//(ReadRegistryInt(mykey, newconfigRootKey,"Use3dlut",m_Use3dlut) != 0);
	m_Use3dlut		          = (GetProfile().GetIntOrDefault("AtmoWinX", "Use3dlut", m_Use3dlut) != 0);

	//(ReadRegistryInt(mykey, newconfigRootKey,"UsePerChWhiteAdj",m_WhiteAdjPerChannel) != 0);
	m_WhiteAdjPerChannel     = (GetProfile().GetIntOrDefault("AtmoWinX", "UsePerChWhiteAdj", m_WhiteAdjPerChannel) != 0);
	sprintf(regKeyName,"%sWhiteAdjPerChannel\\",newconfigRootKey);
	...
	//ReadRegistryInt(mykey, newconfigRootKey,"ColorChanger_iSteps",m_ColorChanger_iSteps);
	m_ColorChanger_iSteps            = GetProfile().GetIntOrDefault("AtmoWinX", "ColorChanger_iSteps", m_ColorChanger_iSteps);
	//ReadRegistryInt(mykey, newconfigRootKey,"ColorChanger_iDelay",m_ColorChanger_iDelay);
	m_ColorChanger_iDelay            = GetProfile().GetIntOrDefault("AtmoWinX", "ColorChanger_iDelay", m_ColorChanger_iDelay);
	//ReadRegistryInt(mykey, newconfigRootKey,"LrColorChanger_iSteps",m_LrColorChanger_iSteps);
	m_LrColorChanger_iSteps          = GetProfile().GetIntOrDefault("AtmoWinX", "LrColorChanger_iSteps", m_LrColorChanger_iSteps);
	//ReadRegistryInt(mykey, newconfigRootKey,"LrColorChanger_iDelay",m_LrColorChanger_iDelay);
	m_LrColorChanger_iDelay          = GetProfile().GetIntOrDefault("AtmoWinX", "LrColorChanger_iDelay", m_LrColorChanger_iDelay);
	//ReadRegistryInt(mykey, newconfigRootKey,"isSetShutdownColor",m_IsSetShutdownColor);
	m_IsSetShutdownColor             = GetProfile().GetIntOrDefault("AtmoWinX", "isSetShutdownColor", m_IsSetShutdownColor);
	//CheckByteValue( ReadRegistryInt(mykey, newconfigRootKey,"ShutdownColor_red",m_ShutdownColor_Red  ));
	m_ShutdownColor_Red              = CheckByteValue(GetProfile().GetIntOrDefault("AtmoWinX", "ShutdownColor_red", m_ShutdownColor_Red));
	//CheckByteValue( ReadRegistryInt(mykey, newconfigRootKey,"ShutdownColor_green",m_ShutdownColor_Green));
	m_ShutdownColor_Green            = CheckByteValue(GetProfile().GetIntOrDefault("AtmoWinX", "ShutdownColor_green", m_ShutdownColor_Green));
	//CheckByteValue( ReadRegistryInt(mykey, newconfigRootKey,"ShutdownColor_blue",m_ShutdownColor_Blue));
	m_ShutdownColor_Blue             = CheckByteValue(GetProfile().GetIntOrDefault("AtmoWinX", "ShutdownColor_blue", m_ShutdownColor_Blue));
	//ReadRegistryInt(mykey, newconfigRootKey,"StaticColor_Red",m_StaticColor_Red);
	m_StaticColor_Red                = GetProfile().GetIntOrDefault("AtmoWinX", "StaticColor_Red", m_StaticColor_Red);
	//ReadRegistryInt(mykey, newconfigRootKey,"StaticColor_Green",m_StaticColor_Green);
	m_StaticColor_Green              = GetProfile().GetIntOrDefault("AtmoWinX", "StaticColor_Green", m_StaticColor_Green);
	//ReadRegistryInt(mykey, newconfigRootKey,"StaticColor_Blue",m_StaticColor_Blue);
	m_StaticColor_Blue               = GetProfile().GetIntOrDefault("AtmoWinX", "StaticColor_Blue", m_StaticColor_Blue);
	//(AtmoFilterMode)ReadRegistryInt(mykey, newconfigRootKey,"LiveViewFilterMode",(int)m_LiveViewFilterMode);
	m_LiveViewFilterMode             = (AtmoFilterMode)GetProfile().GetIntOrDefault("AtmoWinX", "LiveViewFilterMode", (int)m_LiveViewFilterMode);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveViewFilter_PercentNew",m_LiveViewFilter_PercentNew);
	m_LiveViewFilter_PercentNew      = GetProfile().GetIntOrDefault("AtmoWinX", "LiveViewFilter_PercentNew", m_LiveViewFilter_PercentNew);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveViewFilter_MeanLength",m_LiveViewFilter_MeanLength);
	m_LiveViewFilter_MeanLength      = GetProfile().GetIntOrDefault("AtmoWinX", "LiveViewFilter_MeanLength", m_LiveViewFilter_MeanLength);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveViewFilter_MeanThreshold",m_LiveViewFilter_MeanThreshold);
	m_LiveViewFilter_MeanThreshold   = GetProfile().GetIntOrDefault("AtmoWinX", "LiveViewFilter_MeanThreshold", m_LiveViewFilter_MeanThreshold);
	//(ReadRegistryInt(mykey, newconfigRootKey,"show_statistics",ATMO_FALSE) != 0);  
	m_show_statistics                = (GetProfile().GetIntOrDefault("AtmoWinX", "show_statistics", ATMO_FALSE) !=0);
	
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_RowsPerFrame",m_LiveView_RowsPerFrame);
	m_LiveView_RowsPerFrame          = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_RowsPerFrame", m_LiveView_RowsPerFrame);
	...
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_EdgeWeighting",m_LiveView_EdgeWeighting);
	m_LiveView_EdgeWeighting         = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_EdgeWeighting", m_LiveView_EdgeWeighting);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_BrightCorrect",m_LiveView_BrightCorrect);
	m_LiveView_BrightCorrect         = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_BrightCorrect", m_LiveView_BrightCorrect);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_DarknessLimit",m_LiveView_DarknessLimit);
	m_LiveView_DarknessLimit         = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_DarknessLimit", m_LiveView_DarknessLimit);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_HueWinSize",m_LiveView_HueWinSize);
	m_LiveView_HueWinSize            = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_HueWinSize", m_LiveView_HueWinSize);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_SatWinSize",m_LiveView_SatWinSize);
	m_LiveView_SatWinSize            = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_SatWinSize", m_LiveView_SatWinSize);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_Overlap",m_LiveView_Overlap);
	m_LiveView_Overlap               = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_Overlap", m_LiveView_Overlap);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_Saturation",100);
	m_LiveView_Saturation            = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_Saturation", 100);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_Sensitivity",0);
	m_LiveView_Sensitivity           = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_Sensitivity", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_invert",0);
	m_Useinvert                      = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_invert", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_WidescreenMode",m_LiveView_WidescreenMode);
	m_LiveView_WidescreenMode        = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_WidescreenMode", m_LiveView_WidescreenMode);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_HOverscanBorder",m_LiveView_HOverscanBorder);
	m_LiveView_HOverscanBorder       = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_HOverscanBorder", m_LiveView_HOverscanBorder);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_VOverscanBorder",m_LiveView_VOverscanBorder);
	m_LiveView_VOverscanBorder       = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_VOverscanBorder", m_LiveView_VOverscanBorder);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_DisplayNr",m_LiveView_DisplayNr);
	m_LiveView_DisplayNr             = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_DisplayNr", m_LiveView_DisplayNr);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_FrameDelay",m_LiveView_FrameDelay);
	m_LiveView_FrameDelay            = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_FrameDelay", m_LiveView_FrameDelay);
	//ReadRegistryInt(mykey, newconfigRootKey,"LiveView_GDI_FrameRate",m_LiveView_GDI_FrameRate);
	m_LiveView_GDI_FrameRate         = GetProfile().GetIntOrDefault("AtmoWinX", "LiveView_GDI_FrameRate", m_LiveView_GDI_FrameRate);
  ...
  //ReadRegistryInt(mykey, newconfigRootKey,"ZonesBottomCount",m_ZonesBottomCount);
	...
	UpdateZoneCount();
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_global_gamma",m_Hardware_global_gamma);
	m_Hardware_global_gamma          = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_global_gamma", m_Hardware_global_gamma);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_global_contrast",m_Hardware_global_contrast);
	m_Hardware_global_contrast       = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_global_contrast", m_Hardware_global_contrast);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_contrast_red",m_Hardware_contrast_red);
	m_Hardware_contrast_red          = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_contrast_red", m_Hardware_contrast_red);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_contrast_green",m_Hardware_contrast_green);
	m_Hardware_contrast_green        = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_contrast_green", m_Hardware_contrast_green);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_contrast_blue",m_Hardware_contrast_blue);
	m_Hardware_contrast_blue         = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_contrast_blue", m_Hardware_contrast_blue);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_gamma_red",m_Hardware_gamma_red);
	m_Hardware_gamma_red             = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_gamma_red", m_Hardware_gamma_red);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_gamma_green",m_Hardware_gamma_green);
	m_Hardware_gamma_green           = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_gamma_green", m_Hardware_gamma_green);
	//ReadRegistryInt(mykey, newconfigRootKey,"Hardware_gamma_blue",m_Hardware_gamma_blue);
	m_Hardware_gamma_blue            = GetProfile().GetIntOrDefault("AtmoWinX", "Hardware_gamma_blue", m_Hardware_gamma_blue);

	//(AtmoGammaCorrect)ReadRegistryInt(mykey, newconfigRootKey,"Software_gamma_mode",(int)m_Software_gamma_mode);
	m_Software_gamma_mode            = (AtmoGammaCorrect)GetProfile().GetIntOrDefault("AtmoWinX", "Software_gamma_mode", (int)m_Software_gamma_mode);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_gamma_red",m_Software_gamma_red);
  m_Software_gamma_red             = GetProfile().GetIntOrDefault("AtmoWinX", "Software_gamma_red", m_Software_gamma_red);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_gamma_green",m_Software_gamma_green);
	m_Software_gamma_green           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_gamma_green", m_Software_gamma_green);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_gamma_blue",m_Software_gamma_blue);
	m_Software_gamma_blue            = GetProfile().GetIntOrDefault("AtmoWinX", "Software_gamma_blue", m_Software_gamma_blue);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_gamma_global",m_Software_gamma_global);
	m_Software_gamma_global          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_gamma_global", m_Software_gamma_global);
  ...
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_rr",255);
	red_ColorK[256][0]    = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_rr", 255);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_rg",0);
	red_ColorK[256][1]    = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_rg", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_rb",0);
	red_ColorK[256][2]    = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_rb", 0);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_gr",0);
	green_ColorK[256][0]  = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_gr", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_gg",255);
	green_ColorK[256][1]  = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_gg", 255);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_gb",0);
	green_ColorK[256][2]  = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_gb", 0);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_br",0);
	blue_ColorK[256][0]   = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_br", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_bg",0);
	blue_ColorK[256][1]   = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_bg", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_bb",255);
	blue_ColorK[256][2]   = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_bb", 255);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_yr",255);
	red_ColorK[257][0]    = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_yr", 255);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_yg",255);
	red_ColorK[257][1]    = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_yg", 255);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_yb",0);
	red_ColorK[257][2]    = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_yb", 0);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_mr",255);
	green_ColorK[257][0]  = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_mr", 255);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_mg",0);
	green_ColorK[257][1]  = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_mg", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_mb",255);
	green_ColorK[257][2]  = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_mb", 255);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_cr",0);
	blue_ColorK[257][0]   = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_cr", 0);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_cg",255);
	blue_ColorK[257][1]   = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_cg", 255);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_ColK_cb",255);
	blue_ColorK[257][2]   = GetProfile().GetIntOrDefault("AtmoWinX", "Software_ColK_cb", 255);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_5",12);
	red_grid[0]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_5", 12);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_10",25);
	red_grid[1]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_10", 25);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_20",51);
	red_grid[2]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_20", 51);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_30",76);
	red_grid[3]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_30", 76);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_40",102);
	red_grid[4]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_40", 102);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_50",127);
	red_grid[5]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_50", 127);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_60",153);
	red_grid[6]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_60", 153);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_70",178);
	red_grid[7]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_70", 178);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_80",204);
	red_grid[8]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_80", 204);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_90",229);
	red_grid[9]           = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_90", 229);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_red_g_100",255);
	red_grid[10]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_red_g_100", 255);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_5",12);
	green_grid[0]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_5", 12);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_10",25);
	green_grid[1]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_10", 25);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_20",51);	
	green_grid[2]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_20", 51);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_30",76);
	green_grid[3]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_30", 76);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_40",102);
	green_grid[4]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_40", 102);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_50",127);
	green_grid[5]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_50", 127);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_60",153);
	green_grid[6]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_60", 153);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_70",178);
	green_grid[7]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_70", 178);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_80",204);
	green_grid[8]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_80", 204);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_90",229);
	green_grid[9]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_90", 229);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_green_g_100",255);
	green_grid[10]        = GetProfile().GetIntOrDefault("AtmoWinX", "Software_green_g_100", 255);

	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_5",12);
	blue_grid[0]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_5", 12);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_10",25);
	blue_grid[1]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_10", 25);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_20",51);
	blue_grid[2]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_20", 51);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_30",76);
	blue_grid[3]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_30", 76);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_40",102);
	blue_grid[4]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_40", 102);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_50",127);
	blue_grid[5]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_50", 127);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_60",153);
	blue_grid[6]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_60", 153);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_70",178);
	blue_grid[7]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_70", 178);
	//ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_80",204);
	blue_grid[8]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_80", 204);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_90",229);
	blue_grid[9]          = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_90", 229);
  //ReadRegistryInt(mykey, newconfigRootKey,"Software_blue_g_100",255);
	blue_grid[10]         = GetProfile().GetIntOrDefault("AtmoWinX", "Software_blue_g_100", 255);
	...
	//ReadRegistryString(mykey,  newconfigRootKey, "DMX_BaseChannels", buf);
	char *dmx_ch = ReadRegistryString(mykey,  newconfigRootKey, "DMX_BaseChannels", buf); //GetProfile().GetStringOrDefault("AtmoWinX", "DMX_BaseChannels", buf);
	this->setDMX_BaseChannels( dmx_ch );
	free( dmx_ch );

	//atmoduino
	//ReadRegistryInt(mykey, newconfigRootKey,"hAtmoClLeds", m_hAtmoClLeds );
	m_hAtmoClLeds            = GetProfile().GetIntOrDefault("AtmoWinX", "hAtmoClLeds", m_hAtmoClLeds);
	//ReadRegistryInt(mykey, newconfigRootKey,"DMX_RGB_Channels", m_DMX_RGB_Channels );
	m_DMX_RGB_Channels       = GetProfile().GetIntOrDefault("AtmoWinX", "DMX_RGB_Channels", m_DMX_RGB_Channels);
	//ReadRegistryInt(mykey, newconfigRootKey,"DMX_BaudrateIndex", m_DMX_BaudrateIndex ); 
	m_DMX_BaudrateIndex      = GetProfile().GetIntOrDefault("AtmoWinX", "DMX_BaudrateIndex", m_DMX_BaudrateIndex);
	//ReadRegistryInt(mykey, newconfigRootKey,"Ardu_BaudrateIndex", m_Ardu_BaudrateIndex ); 
	m_Ardu_BaudrateIndex     = GetProfile().GetIntOrDefault("AtmoWinX", "Ardu_BaudrateIndex", m_Ardu_BaudrateIndex);

	//ReadRegistryInt(mykey, newconfigRootKey,"MoMo_Channels", m_MoMo_Channels );
	m_MoMo_Channels          = GetProfile().GetIntOrDefault("AtmoWinX", "MoMo_Channels", m_MoMo_Channels);
	if(m_MoMo_Channels > 254) m_MoMo_Channels = 254;
	if(m_MoMo_Channels < 0)   m_MoMo_Channels = 2;

	//ReadRegistryInt(mykey, newconfigRootKey,"Fnordlicht_Amount", m_Fnordlicht_Amount );
	m_Fnordlicht_Amount      = GetProfile().GetIntOrDefault("AtmoWinX", "Fnordlicht_Amount", m_Fnordlicht_Amount);
	...
	//ReadRegistryInt(mykey, newconfigRootKey,"CurrentChannelAssignment",m_CurrentChannelAssignment);
	m_CurrentChannelAssignment = GetProfile().GetIntOrDefault("AtmoWinX", "CurrentChannelAssignment", m_CurrentChannelAssignment);
