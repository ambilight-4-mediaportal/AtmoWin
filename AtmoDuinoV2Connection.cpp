...
ATMO_BOOL CAtmoDuinoV2Connection::OpenConnection() {
    ...
    GetCommState(m_hComport, &dcb);   // ger current serialport settings
		...
		switch (m_pAtmoConfig->getArduV2_BaudrateIndex())
		{
		// set baud speed
		...
		case 3: dcb.BaudRate = 250000;
			break;
		case 4: dcb.BaudRate = 500000;
			break;
		case 5: dcb.BaudRate = 1000000;
			break;
		case 6: dcb.BaudRate = 2000000;
			break;
		case 7: dcb.BaudRate = 4000000;
			break;
		case 8: dcb.BaudRate = 6000000;
			break;
		case 9: dcb.BaudRate = 8000000;
			break;
		case 10: dcb.BaudRate = 10000000;
			break;
		default:
