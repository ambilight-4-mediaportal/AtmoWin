...
int IsValidDmxStartString(char *startChannels, int maxChannel)
{
...
int *ConvertDmxStartChannelsToInt(int numChannels, char *startChannels, int maxChannel)
{
  ...
  while(ch < numChannels) {
        if(next_dmx_ch>maxChannel) next_dmx_ch=0; // wrap arround :) better than indexing memory out of range
